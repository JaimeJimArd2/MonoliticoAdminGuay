...
Route::controller(\App\Http\Controllers\PeticioneController::class)->group(function () {Route::get('peticiones/index', 'index')->name('peticiones.index');
...
Route::delete('admin/peticiones/{id}', 'destroy')->name('admin.peticiones.destroy');
