        ...
        <div class = "row w-100">
            <div class="col">
                <div id="demo" class="carousel slide" data-bs-rie="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item-active">
                            ...
                            <div class="carousel-caption">
                                ...
                                <div class="text-center mt-5"><a type="button" class=" btn btn-danger center-block" href="/peticion/add">Inicia una petición</a></div>
                            </div>
                        </div>
                    ...
                    <button class="carosusel-control-prev" type="button" data-bs-target ="#demo" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon"></span>
                    </button>
                    <button class="carosusel-control-next" type="button" data-bs-target ="#demo" data-bs-slide="next">
